      ...
      <div className="container">
        <div className="grid grid-cols-1 min-sm:grid-cols-1 min-md:grid-cols-3 gap-8 text-white">
          <div className="space-y-6">
            <h2 className="text-2xl font-bold uppercase">coders cafe</h2>
        ...
        <p className="text-center mt-6 text-white text-sm">Copywrite © 2024 CoffeeCode. All rights reserved.</p>
      </div>
    </footer>
  );
};
